...
import 'package:chalkboard/model/cityStateApiModel.dart';
...
import 'package:chalkboard/widget/gradient_widget.dart';
        ...
        try {
          ...
          if (widget.isThirdpartySignup) {
            ...
            await showNormalAlretDialog(
              ...
              message:
                  'you have successfully signed up. Now you can continue with ChalkBoard',
            );
  ...
  Future<bool?> showBackConformationDialog(BuildContext context) {
    return showDialog<bool>(
      ...
      builder: (ct) => AlertDialog(
        ...
        content: Text('You can\'t use Chalkboard with out signing up'),
        actions: [
          TextButton(
